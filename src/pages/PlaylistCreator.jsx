...
const  onDragEnd = result => {
  ...
  if(source.droppableId === "featured_playlist" && destination.droppableId === "my_playlist"){
    let playlistObject = playlists.find(playlist => playlist.id === draggableId);
    let isPlaylistAlreadyAdded = !!userPlaylists.filter(playlist => playlist.id === draggableId).length;
