...
const PlaylistContainer = styled.div`
    border: 1px
        ${props => (props.isDraggingOver ? 'dashed #ccc' : 'solid transparent')};
`;
...
const UserPlaylists = () => {
  ...
  return (
    ...
    {(provided, snapshot) => (
      <PlaylistContainer ref={provided.innerRef} isDraggingOver={snapshot.isDraggingOver} {...provided.droppableProps} className="flex-1 overflow-y-auto overflow-x-none py-2 d-flex flex-column">
